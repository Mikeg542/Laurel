...
?>
<div class='clear'></div>
<header id='masthead' class='site-header header6 pull-up' role='banner'>
	<div class='container'>
		<div class='row'>
			<div class='site-branding col-sm-3 header6'>
				<?php 
			...
			<nav id='site-navigation' class='main-navigation header6 col-sm-9 col-xs-12' role='navigation'>
				<?php
				if( of_get_option( 'show_search' ) ) { 
				?>
					<div class='header6 search-bar'>
